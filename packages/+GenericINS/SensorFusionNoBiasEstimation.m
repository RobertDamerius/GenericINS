...
classdef SensorFusionNoBiasEstimation < handle
    ...
    methods(Static,Access=private)
        ...
        function g = Gravity(altitude, latitude, R0)
            %GenericINS.SensorFusionNoBiasEstimation.Gravity Compute the local gravity g [m/s^2] for a given position using the WGS84 earth reference model.
            % 
            % PARAMETERS
        ...
        function xOut = ProcessModelEuler(x, w, u, Ts, dcmIMUBody2Sensor)
            ...
            % WGS84 properties
            [Rn, Re, R0] = GenericINS.SensorFusionNoBiasEstimation.WGS84(x(1));
            localGravity = GenericINS.SensorFusionNoBiasEstimation.Gravity(x(3), x(1), R0);
